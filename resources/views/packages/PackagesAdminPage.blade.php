...
@extends('layouts2.app') @section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div style="float: right">
                ...
                <a href='{{route("ViewSubscribers")}}' type="button" id='viewsubscribers' class="btn  themeBtn">
                              View Subscribers
                            </a>
            </div>
        </div>
        ...
        <ul style="list-style: none;" id="packageList">
            ...
            <li>
                <div style='margin:10px' class="card">
                    <h5 style="color: black" class="card-header">{{$packages->name}}</h5>
                    <div class="card-body">
                        <p style="color: black" class="card-text">{{$packages->description}}</p>
                        <p>
                            <h5 style="color: black; float: right" class="card-title">${{$packages->price}} /Month</h5></p>
                      <!--   <a  class="btn themeBtn editPackage"  packageID="{{$packages->id}}" data-title="{{$packages->title}}" data-description="{{$packages->description}}" data-price="{{$packages->price}}" data-rebill-price="{{$packages->rebill_price}}" data-rebill-commission="{{$packages->rebill_commission}}" data-sku="{{$packages->sku}}">Edit</a> -->
                        <a href='#' class="btn themeBtn" id="deletepackage" packageID="{{$packages->id}}">Delete</a>
                    </div>
                </div>
            </li>
            @endforeach
