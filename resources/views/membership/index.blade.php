                    ...
                    <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><span class="text-{{$membership->status == 1 ? 'success' : 'warning'}}">{{$membership->status == 1 ? 'Active' : 'Inactive'}}</span></td>
                            ...
                            <td>
                              <div class="d-flex">
                                ...
                                <a href="" class="mr-4 editbtn" data-toggle="modal" data-target="#editMembership" data-membershipID="{{$membership->id}}" data-membershipName="{{$membership->name}}" data-membershipPrice="{{$membership->price}}" data-membershipLength="{{$membership->characters_length}}" data-membershipVoiceType="{{$membership->voice_type}}" data-status="{{$membership->status}}" data-package="{{$membership->package->id}}">
                                  <img src="assets/img/edit.png" width="" data-toggle="tooltip" title="Edit">
                                </a>
                                <a href="" class="mr-4 deletebtn" data-toggle="modal" data-target="#deleteMembership" data-membershipID="{{$membership->id}}">
        ...
        $.ajax({
           ...
           success:function(response){
            ...
            if(response.error == false){
             ...
             '<td>'+
              ' <div class="d-flex">'+
              '<a href="" class="mr-4 editbtn" data-toggle="modal" data-target="#editMembership" data-membershipID="'+ this.id +'" data-membershipName="'+this.name+'" data-membershipPrice="'+this.price+'" data-membershipLength="'+this.characters_length+'" data-membershipVoiceType="'+ this.voice_type+'" data-status="'+this.status+'"><img src="{{asset('assets/img/edit.png')}}" width="" data-toggle="tooltip" title="Edit"></a>'+
              '<a href="" class="mr-4 deletebtn" data-toggle="modal" data-target="#deleteMembership" data-membershipID="'+ this.id +'" ><img src="{{asset('assets/img/deleteicon.png')}}" width="" data-toggle="tooltip" title="Delete"></a>'+
        ...
        $.ajax({
           ...
           success:function(response){
            ...
            '<td>'+response.data.name +'</td>'+
             ...
             '<td>'+
              ' <div class="d-flex">'+
              '<a href="" class="mr-4 editbtn" data-toggle="modal" data-target="#editMembership" data-membershipID="'+ response.data.id +'" data-membershipName="'+response.data.name+'" data-membershipPrice="'+response.data.price+'" data-membershipLength="'+response.data.characters_length+'" data-membershipVoiceType="'+ response.data.voice_type+'" data-status="'+response.data.status+'"><img src="{{asset('assets/img/edit.png')}}" width="" data-toggle="tooltip" title="Edit"></a>'+
              '<a href="" class="mr-4 deletebtn" data-toggle="modal" data-target="#deleteMembership" data-membershipID="'+ response.data.id +'" ><img src="{{asset('assets/img/deleteicon.png')}}" width="" data-toggle="tooltip" title="Delete"></a>'+
      ...
      success:function(response){
       ...
       let output='';
        ...
        output += '<tr>'+
             ...
             '<td>'+
              ' <div class="d-flex">'+
              '<a href="" class="mr-4 editbtn" data-toggle="modal" data-target="#editMembership" data-membershipID="'+ this.id +'" ><img src="{{asset('assets/img/edit.png')}}" width="" data-toggle="tooltip" title="Edit"></a>'+
              '<a href="" class="mr-4 deletebtn" data-toggle="modal" data-target="#deleteMembership" data-membershipID="'+ this.id +'" ><img src="{{asset('assets/img/deleteicon.png')}}" width="" data-toggle="tooltip" title="Delete"></a>'+
