                    ...
                    <table class="table">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex">
                                <a href="" class="mr-4 editbtn" data-toggle="modal" data-target="#editUser" data-userID="<?php echo e($user->id); ?>"  data-membershipID="<?php echo e($user->membership_id); ?>" data-status="<?php echo e($user->status); ?>"  data-name="<?php echo e($user->name); ?>" data-prodSku="<?php echo e($user->memberships->package->sku); ?>">
                ...
                <div class="form-group">
                                ...
                                <select class="form-control" id="membership_id" name="membership_id" required>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $memberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <option value="<?php echo e($membership->package->sku); ?>"><?php echo e($membership->package->title); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <?php endif; ?>                    
                                </select>
                            </div>
