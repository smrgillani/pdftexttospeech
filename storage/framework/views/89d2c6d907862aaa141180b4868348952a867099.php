               ...
               <div class="row mt-5">
                 <div class="col-md-12">
                   <div class="convertTextSpeech cardBox">
                    <a class="btn newThemeBtnStyle mr-2 pull-right" href="<?php echo e(route('book.chapter',$book->id)); ?>">Previous</a>
                     <h5>
                       ...
                       <form>
                        ...
                        <input type="hidden" name="book_name" value="<?php echo e($book->name); ?>">
                        <input type="hidden" name="no_of_pages" value="<?php echo e($book->no_of_pages); ?>">
                           ...
                           <div class="col-md-6">
                             <div class="form-group">
                                ...
                                <select class="form-control fileprocess" id="language" name="language" required>
                                  ...
                                  <?php $__empty_1 = true; $__currentLoopData = $language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$lan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                 
                                  <option value="<?php echo e($lan->code); ?>" <?php if($lan->code == 'en-GB'): ?> selected <?php endif; ?>><?php echo e($lan->name); ?></option>
   ...
   $(function() {
    ...
    var $language=$("#language").val();
     ...
     $.ajax({
      ...
      type : 'get',
      url : '<?php echo e(route("userdefaultvoices")); ?>',
    ...
    var voicename=$("#voicename option:first").val();
     ...
     if(voicename !== 'undefined'){
      ...
      type : 'get',
      url : '<?php echo e(route("voicegender")); ?>',
    ...
    $('#closePlayer').click(function(){
      ...
      type : 'get',
      url : '<?php echo e(route("uservoices")); ?>',
      data:{'language':$value},
      success:function(data){
      $('#voicename').html(data);
      ...
      type : 'get',
      url : '<?php echo e(route("uservoicesdemo")); ?>',
      data:{'language':$value},
      success:function(data){
    ...
    $('#voicename_demo').change(function(){
      ...
      type : 'get',
      url : '<?php echo e(route("voicegenderdemo")); ?>',
      data:{'voicename':$value},
      success:function(data){
      ...
      $.each($("select"),function(element){
        ...
        $('body').addClass("main-dashboard loader");
          ...
          $.ajax({
           ...
           url:'<?php echo e(route("testprocess")); ?>',
           ...
           if(response.error == false){
            ...
            $('#alertMessage').modal("show");
                $('#player').html("");
                $('#player').player("<?php echo e(asset('Demo/demo.mp3')); ?>");
                $('#audioPlayerBox').show();

                $(".downloadIcon a").attr("href","<?php echo e(asset('Demo/demo.mp3')); ?>");
           }else{
            $('#message').text(response.message);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts2.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sarmad/Work/FreelanceWork/PhpProjects/AudioBot/html/resources/views/chapters/process.blade.php ENDPATH**/ ?>