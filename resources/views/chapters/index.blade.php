              ...
              <div class="row mt-5 mb-5 bookPages">
                 <div class="col-md-12">
                  <div class="cardBox">
                    ...
                    <!-- href="{{route('chapter.process',$book->id)}}" -->
                    <a class="btn newThemeBtnStyle mr-2 pull-right"  id="nextbtn" data-bookID="{{$book->id}}">Next</a>
                   <a class="btn newThemeBtnStyle mr-2 pull-right" href="{{route('chapter.process',$book->id)}}">Skip This Step</a>
                   <a class="btn newThemeBtnStyle mr-2 pull-right" href="{{route('book.show',$book->id)}}">Previous</a>
                      <h5>
                       Chapters
                     </h5>
        ...
        $.ajax({
           ...
           data: { bookid:bookid },
             ...
             success:function(data){
              ...
              if(data.length >0){
                var url="{{route('chapter.process',':id')}}";
