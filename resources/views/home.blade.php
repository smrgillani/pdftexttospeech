               ...
               <div class="row">
                  <div class="col-md-10 offset-md-1">
                     <div class="d-flex pdfBoxMain justify-content-between align-items-center mt-5 text-center">
                        <div>
                           <div class="pdfBox">
                              <img src="{{asset('assets/img/uploadicon.png')}}">
                           </div>
                           <p class="mt-3">
                              Upload PDF File
                           </p>
                        ...
                        <div>
                           <div class="pdfBox">
                              <img src="{{asset('assets/img/setchaptericon.png')}}">
                           </div>
                           <p class="mt-3">
                        ...
                        <div>
                           <div class="pdfBox noneAfter">
                              <img src="{{asset('assets/img/listenicon.png')}}">
                           </div>
                           <p class="mt-3">
                              Listen Audio
                           </p>
                        ...
                        <div class="d-flex align-items-center">
                              ...
                              <div class="choosePDF mr-4">
                                 ...
                                 <label for="chooseFile">
                                     <img src="{{asset('assets/img/choosefileicon.png')}}">
                                 <p>
                                    Choose PDF File
                                 </p>
                                 </label>
