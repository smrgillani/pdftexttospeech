              ...
              <div class="row">
               ...
               <div class="row mt-3">
                 <div class="col-md-12 text-right">
                  <?php if(count($book->audioVoices) > 0): ?>
                   <a class="btn themeBtn" href="<?php echo e(route('bookaudio',$book->id)); ?>">View Audio</a>
                  <?php endif; ?>
                 </div>
               </div>
               ...
               <div class="row mt-5 mb-5 bookPages">
                 <div class="col-md-12">
                  <div class="cardBox">
                    ...
                    <a class="btn newThemeBtnStyle mr-2 pull-right" href="<?php echo e(route('book.chapter',$book->id)); ?>">Next</a>
                   
                    <a class="btn btn-danger mr-2 pull-right" href="<?php echo e(route('book.index')); ?>">Cancel</a>
                    ...
                    <div class="row" id="PageTabs">
                      <div class="col-md-3">
                        <ul class="nav nav-pills">
                          <?php $__currentLoopData = $book->pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                          <li class="nav-item">
                            <a class="nav-link <?php if($key==0): ?> active  <?php endif; ?>" data-toggle="pill" href="#page<?php echo e($page['page_no']); ?>">Page <?php echo e($page['page_no']); ?></a>
                          </li>
                      ...
                      <div class="col-md-9">
                        ...
                        <div class="tab-content">
                          ...
                          <div class="tab-pane container <?php if($key==0): ?> active  <?php endif; ?>" id="page<?php echo e($page['page_no']); ?>">
                            
                            <div class="row">
                              <div class="col-md-12 text-right">
                              <a class="btn greenBtn mr-2" data-toggle="modal" id="addPage" data-target="#createPage">
                    Add New Page</a>
                               <a class="btn themeBtn mr-2 pr-5 pl-5 editPage"  data-pageID="<?php echo e($page['page_no']); ?>" data-bookID="<?php echo e($page['book_id']); ?>" >Edit</a>



                               <a class="btn themeBtn pr-5 pl-5 pageDel" data-pageID="<?php echo e($page['page_no']); ?>" data-bookID="<?php echo e($page['book_id']); ?>" data-toggle="modal" data-target="#delPage">Delete</a>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="pageContentBox">
                                  <p id="ContentpageNo<?php echo e($page['page_no']); ?>">
...
<?php $__env->startPush('scripts'); ?>
   ...
   $(function() {
    ...
    $('body').on('click','#pageUpdate',function(){
      ...
      var url="<?php echo e(route('pageedit',':id')); ?>";
    ...
    $('body').on('click', '.pageDel',function(){
     ...
     $('body').on('click', '#deletePageBtn',function(e){
      ...
      e.preventDefault();
        ...
        var url="<?php echo e(route('page.destroy',':id')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts2.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sarmad/Work/FreelanceWork/PhpProjects/AudioBot/html/resources/views/books/detail.blade.php ENDPATH**/ ?>