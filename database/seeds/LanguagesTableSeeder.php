...
'zu'=>'Zulu',
    ...
    public function run()
    {
    	 $languages=Voice::distinct()->pluck('language')->toArray();
            ...
            $membershipLanguages=Language::where('membership_id',1)->get();

                foreach ($membershipLanguages as $language) {
                	
                    $voices=Voice::Where('language',$language->name)->get(['ssml_gender','name','natural_sample_rate_hertz']);
                        ...
                        $ssml_gender=strtok($voice, ' ');
                         $voiceCode=  substr($voice, strpos($voice, " ") + 1);
                          ...
                          $myArr=explode(':"',$languageCode2);
                       
                          if($languageCode1==$myArr[2]){
